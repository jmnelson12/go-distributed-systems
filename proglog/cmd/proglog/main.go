...
func main() {
	...
	cmd := &cobra.Command{
		...
		// Cobra calls the RunE function you set on your command when the command runs.
		RunE: cli.run,
	}
...
the agent’s configuration. Cobra calls setupConfig() before running the command’s
RunE function.
*/
